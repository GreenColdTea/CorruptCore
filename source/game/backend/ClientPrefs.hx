...
class ClientPrefs {
	...
	**/
    ...
    public static function loadPrefs() {
        ...
        if (FlxG.save.data.gameplaySettings != null) gameplaySettings = FlxG.save.data.gameplaySettings;
    ...
    public static function toggleVolumeKeys(turnOn:Bool = true) {
        final keys = turnOn ? [Init.muteKeys, Init.volumeDownKeys, Init.volumeUpKeys] : [[], [], []];
        FlxG.sound.muteKeys = keys[0];
        FlxG.sound.volumeDownKeys = keys[1];
        FlxG.sound.volumeUpKeys = keys[2];
    }
}