...
class OptionsState extends MusicBeatState
{
	...
	function openSelectedSubstate(label:String) {
		switch(label) {
			...
			case 'Controls':
				openSubState(new game.substates.options.ControlsSubState());
			case 'Graphics':
				openSubState(new game.substates.options.GraphicsSettingsSubState());
			case 'Visuals and UI':
				openSubState(new game.substates.options.VisualsUISubState());
			case 'Gameplay':
				openSubState(new game.substates.options.GameplaySettingsSubState());
			case 'Misc':
